    ...
    <section id="pricing" className="bg-white dark:bg-black">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <div className="text-sm font-bold tracking-wider text-teal-500 uppercase">Pricing</div>
        ...
        <div className="space-y-8 place-content-center grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          >
            ...
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Landing page for marketing purpose and to let customer contact you for more
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center my-8">
              ...
              <span class="text-gray-500 dark:text-gray-400">per dev / hour</span>
            </div>
