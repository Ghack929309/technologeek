...
export const Pricing = () => {
  return (
    <section id="pricing" className="bg-white dark:bg-trueGray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <div className="text-sm font-bold tracking-wider text-indigo-600 uppercase">Pricing</div>
          ...
          <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
            We believe in keeping things simple and honest. Our pricing is free of gimmicks and
            hidden fees. With us, you'll always know exactly what you're getting and what it costs.
            No tricks, just transparent pricing that makes your decision-making process easier.
          </p>
        </div>
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-trueGray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">Single/Landing Page</h3>
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              For landing pages. To let people know about your business and share your contact
              information.
            </p>
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                <CheckIcon />
                <span>SEO optimization for better search engine visibility </span>
              </li>
              <li className="flex items-center space-x-3">
                <CheckIcon />
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-trueGray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">Software Development</h3>
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Custom Web Application, Startup Software, Automation Software, Mobile App Development
              etc...
            </p>
            <div className="flex justify-center items-baseline my-8">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-trueGray-800 dark:text-white">
            ...
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Elevate your team's potential and productivity with our experienced and passionate
              Senior Developers.
            </p>
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-4xl font-extrabold">$65</span>
              <span class="text-gray-500 dark:text-gray-400">/dev/hour</span>
            </div>
