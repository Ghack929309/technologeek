	...
	return (
		<div className="flex flex-col items-start justify-center px-12 max-w-3xl mx-auto">
			...
			<Section>
				...
				<p>
					Technologeek ("we," "our," or "us") is committed to safeguarding your
			...
			<Section>
				...
				<ul>
					<li>
						Service providers, business partners, and contractors necessary for
			...
			<Section>
				...
				<p>
					...
					Please review the privacy policies of those websites before providing
			...
			<Section>
				...
				<p>
					...
					in our practices. The updated policy will be posted on our website,
