...
export const Heading = ({ children, as = "h1", size = "4xl" }) => {
  ...
  return (
    <Tag
      className={`text-${size} mb-1 font-bold leading-snug tracking-tight text-gray-800 lg:text-${size} lg:leading-tight xl:leading-tight dark:text-white`}
    >
      {children}
    </Tag>
  );
...
const Privacy = () => {
  return (
    <div className="flex flex-col items-start justify-center px-12 max-w-3xl mx-auto">
      ...
      <Section>
        ...
        <p>
          Technologeek ("we," "our," or "us") is committed to safeguarding your privacy. This
          Privacy Policy outlines how we collect, use, disclose, and protect your personal
          information when you use our website or services. By accessing or using our website, you
      ...
      <Section>
        ...
        <Section>
          ...
          <ul>
            <li>Usage data (e.g., IP address, browser type, referring pages)</li>
      ...
      <Section>
        ...
        <ul>
          <li>
            Service providers, business partners, and contractors necessary for the operation of our
            services
          </li>
      ...
      <Section>
        ...
        <p>
          ...
          disclosure, or alteration. However, no data transmission over the internet is entirely
      ...
      <Section>
        ...
        <p>
          ...
          privacy practices or content of these websites. Please review the privacy policies of
      ...
      <Section>
        ...
        <p>
          ...
          The updated policy will be posted on our website, and the date of the latest revision will
          be indicated.
        </p>
      </Section>
      ...
      <Section>
        ...
        <p>
          By using our website or services, you acknowledge that you have read and agree to this
          Privacy Policy.
        </p>
      </Section>
    </div>
